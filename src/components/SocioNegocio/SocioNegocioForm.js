...
import { add, update } from "../../slices/configuraciones/socioNegociosSlice";

export const SocioNegocioForm = ({ modeEdit, datos }) => {
    ...
    onSubmit: async (values, helpers) => {
      if (!modeEdit) {
        ...
        try {
          ...
          await apiClient.put(
            `/configuraciones/socioNegocios/${datos.id}`,
            json
          );
